...
def main_degree_distribution_similarity(orig, graphgan_graph, dpgraphgan_graph, dpgraphvae_graph, netgan_graph, graphrnn_graph, graphvae_graph):
    orig_degree_vec_list = get_degree_vec_list(orig)
    graphgan_degree_vec_list = get_degree_vec_list(graphgan_graph)
    ...
    generated_graph_list = [graphgan_degree_vec_list, graphvae_degree_vec_list, netgan_degree_vec_list, graphrnn_degree_vec_list,\
...
if __name__ == '__main__':
    ...
    if args.dataset == 'imdb':
        ...
        GGAN_graph = load_graphs(data_folder + 'generated/GGAN_new_IMDB_MULTI.pkl')
        DPGGAN_graph = load_graphs(data_folder + 'generated/DPGGAN_new_IMDB_MULTI.pkl')
        DPGVAE_graph = load_graphs(data_folder + 'generated/DPGVAE_new_IMDB_MULTI.pkl')
        GVAE_graph = load_graphs(data_folder + 'generated/GVAE_new_IMDB_MULTI.pkl')
        ...
        GGAN_graph = load_graphs(data_folder + 'generated/GGAN_new_dblp2.pkl')
        DPGGAN_graph = load_graphs(data_folder + 'generated/DPGGAN_new_dblp2.pkl')
        DPGVAE_graph = load_graphs(data_folder + 'generated/DPGVAE_new_dblp2.pkl')
        GVAE_graph = load_graphs(data_folder + 'generated/GVAE_new_dblp2.pkl')
    ...
    if args.metric_type == 'degree':
        main_degree_distribution_similarity(orig, GGAN_graph, DPGGAN_graph, DPGVAE_graph, netgan_graph, graphrnn_graph, GVAE_graph)
    else:
        if args.graph is None:
            result_list = main_motif_distribution_similarity(orig, DPGGAN_graph, DPGVAE_graph, netgan_graph, graphrnn_graph, GVAE_graph)
            args.graph = 'all'
        elif args.graph == 'DPGGAN_graph':
            result_list = main_motif_distribution_similarity_one_graph(orig, DPGGAN_graph, top_N_graph=args.top_N)
        elif args.graph == 'DPGVAE_graph':
            result_list = main_motif_distribution_similarity_one_graph(orig, DPGVAE_graph, top_N_graph=args.top_N)
        ...
        elif args.graph == 'GVAE_graph':
            result_list = main_motif_distribution_similarity_one_graph(orig, GVAE_graph, top_N_graph=args.top_N)
        else:
            print("wrong args.")
            exit(1)
            
        with open(log_folder+'{}_{}_motif.txt'.format(args.dataset, args.graph), 'a') as file:
