...
from graph_classification_exp.models.graphcnn import GraphCNN
...
def main():
    ...
    parser.add_argument('--dataset', type=str, default="DPGraphGAN_Resampled_IMDB_MULTI", help='name of dataset')
